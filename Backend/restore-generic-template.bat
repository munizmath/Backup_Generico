@echo off
REM restore-generic-template.bat - Template genérico de restauração para qualquer projeto
REM Uso: restore-generic-template.bat [BACKUP_NAME] [PROJECT_DIR] [BACKUP_DIR]
...
if "%~1"=="" (
    ...
    echo Uso: restore-generic-template.bat [BACKUP_NAME] [PROJECT_DIR] [BACKUP_DIR]
    echo Exemplo: restore-generic-template.bat "MeuProjeto_backup_20241014_130702" "C:\MeuProjeto" "C:\Backups"
    pause
    exit /b 1
)
